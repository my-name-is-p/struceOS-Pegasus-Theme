            ...
            Row { //settings_panel_content_columns
                            ...
                            CustomCheckbox {
                                ...
                                MouseArea { //checkbox_click
                                    ...
                                    onClicked: {
                                        ...
                                        api.memory.set("struceOS_gameView_allGames", c.all)
                                        collectionsList.model.populateModel()
                                        c.i = current
                                    }
                                }
                            }
                ...
                Item { //settings_panel_content_column2
                    ...
                    Item { //general_settings
                        ...
                        Row { //general_settings_clock
                            id: general_settings_clock
                            ...
                            Text { //general_settings_mute_label
                                id: general_settings_clock_label
                                text: "12hr clock:"
                                color: p.white
                            ...
                            CustomCheckbox {
                                id: general_settings_clock_checkbox
                                anchors.right: parent.right

                                state: settings.twelvehour ? "checked" : ""

                                MouseArea { //checkbox_click
                                    id: general_settings_clock_chekbox_click
                                    anchors.fill: parent
                                    cursorShape: Qt.PointingHandCursor
                        ...
                        Row { //general_settings_mute
                            ...
                            anchors.top: general_settings_clock.bottom
                            ...
                            CustomCheckbox {
                                ...
                                MouseArea { //checkbox_click
                                    ...
                                    onClicked: {
                                        select.play()
                                        parent.state = parent.state != "checked" ? "checked" : ""
