...
Item {
    ...
    property string accent: settings.theme.accent
    property string accent_light: settings.theme.accent_light
    property string black: settings.theme.black
